...
def login(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            session_key = request.session.session_key # назначаем сессионный ключ
            ...
            if user:
                ...
                if session_key:
                    Cart.objects.filter(session_key = session_key).update(user=user) # фильтрация по сессионному ключу
